...
class CustomerController extends Controller
{
    ...
    public function add_same_profile_all_members(Request $request)
    {
        ...
        if ($Profile->count() > 0) {
            ...
            if ($request->is_global == 0) {
                ...
                $message = "The link is added to " . $token->first_name . ' ' . $token->last_name . "'s card.";
            } else {
                ...
                $message = "The link is added to all teammates.";
            }
            ...
            foreach ($Users as $user) {
                ...
                if ($request->is_global == 0) {
                    $message = "The link is added to " . $user->first_name . ' ' . $user->last_name . "'s card.";
                }
    ...
    public function update_same_profile_all_members(Request $request)
    {
        ...
        if ($global_id == '' || $global_id == NULL || $global_id == 'NULL' || $global_id == null || $global_id == 'null' || $global_id == '0' || $global_id == 0) {
            ...
            $message = "The link is updated to " . $token->first_name . ' ' . $token->last_name . "'s card.";
        } else {
            ...
            $message = "The link is updated to all teammates.";
        }
    ...
    public function delete_same_profile_all_members(Request $request)
    {
        ...
        if ($global_id == '' || $global_id == NULL || $global_id == 'NULL' || $global_id == null || $global_id == 'null' || $global_id == '0' || $global_id == 0) {
            $CustomerProfileUpdateObjects = CustomerProfile::where('id', $request->customer_profile_id)->get();
            $message = "The link is deleted from " . $token->first_name . ' ' . $token->last_name . "'s card.";
        } else {
            ...
            $message = "The link is deleted for all teammates.";
        }
