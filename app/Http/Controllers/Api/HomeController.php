            ...
            if (!empty($result['results'])) {
                ...
                if ($contactId) {
                    ...
                    $newNoteData = [
                        ...
                        'metadata' => [
                            'body' => $request->note ?? '' . PHP_EOL . '(Contact owner email:  ' . $created_email . ')', // Replace with the actual note content
                        ],
                    ];
