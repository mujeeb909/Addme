...
class TemplateController extends Controller
{
    ...
    public function create_template_profile(Request $request)
    {
        ...
        if ($Profile->count() > 0) {
            ...
            $data['success'] = TRUE;
            $data['message'] = 'The template link has been updated successfully.';
    ...
    public function delete_template_profile(Request $request)
    {
        ...
        if ($CustomerProfileTemplate->count() > 0) {
            ...
            $data['success'] = TRUE;
            $data['message'] = 'The link is removed from the template.';
    ...
    public function reorder_template_profiles(Request $request)
    {
        ...
        $data['success'] = TRUE;
        $data['message'] = 'The template links sequence has been updated successfully.';
