...
class HomeController extends Controller
{
    ...
    private function lang($language)
    {
        if ($language == 'de') {
            ...
            $list['last_name_validation_alert'] = 'Der Nachname sollte keine Zahlen oder Sonderzeichen enthalten..';  // Last Name Validation
            $list['email_alert'] = 'Bitte E-Mail eingeben.';
            $list['email_validation_alert'] = 'Bitte fügen Sie eine gültige E-Mail-Adresse hinzu'; // Email Validation
