    ...
    <div class="col-md-12 col-xs-12 col-lg-6 shadow-profile bg-row" id="content-section">
                                        ...
                                        @if ($row->profile_link == 'popup-link')
                                            <a id="{{ $row->title_de }}" href="javascript:;"
                                                ...
                                                <div class="profile-title">
                                                    <h6>{{ $row->title_de }} {{ $settings['btn_color']}}</h6>
                                                </div>
                                            </a>
                                        @else
        ...
        <script type="text/javascript">
            ...
            function addPerson() {
                ...
                // Check first name for blank input
                if (first_name == '') {
                ...
                // Check first name should not have any number or characters
                ...
                // Check Last name should not have any number or characters
                ...
                // Check for Email input should not be blank
                if (email == '') {
                    $('#checkboxcontact').prop('checked', false);
